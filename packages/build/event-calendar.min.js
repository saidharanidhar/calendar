...
var EventCalendar = (function () {
	...
	function requireGlobal () {
		...
		global$1 =
		  ...
		  (function () { return this; })() || global$1 || Function('return this')();
		return global$1;
	}
	...
	function requireIsCallable () {
		...
		var $documentAll = /*@__PURE__*/ requireDocumentAll();
	...
	var isIterable$5;
	var hasRequiredIsIterable$6;

	function requireIsIterable$6 () {
		if (hasRequiredIsIterable$6) return isIterable$5;
		hasRequiredIsIterable$6 = 1;
		var classof = /*@__PURE__*/ requireClassof();
		var hasOwn = /*@__PURE__*/ requireHasOwnProperty();
		var isNullOrUndefined = /*@__PURE__*/ requireIsNullOrUndefined();
		var wellKnownSymbol = /*@__PURE__*/ requireWellKnownSymbol();
	...
	var isIterable_1;
	var hasRequiredIsIterable$5;

	function requireIsIterable$5 () {
		if (hasRequiredIsIterable$5) return isIterable_1;
		hasRequiredIsIterable$5 = 1;
		requireEs_array_iterator();
		requireEs_string_iterator();
		var isIterable = /*@__PURE__*/ requireIsIterable$6();
	...
	var isIterable$4;
	var hasRequiredIsIterable$4;

	function requireIsIterable$4 () {
		if (hasRequiredIsIterable$4) return isIterable$4;
		hasRequiredIsIterable$4 = 1;
		var parent = /*@__PURE__*/ requireIsIterable$5();
	...
	var isIterable$3;
	var hasRequiredIsIterable$3;

	function requireIsIterable$3 () {
		if (hasRequiredIsIterable$3) return isIterable$3;
		hasRequiredIsIterable$3 = 1;
		var parent = /*@__PURE__*/ requireIsIterable$4();
	...
	var isIterable$2;
	var hasRequiredIsIterable$2;

	function requireIsIterable$2 () {
		if (hasRequiredIsIterable$2) return isIterable$2;
		hasRequiredIsIterable$2 = 1;
		var parent = /*@__PURE__*/ requireIsIterable$3();
	...
	function requireIsIterable$1 () {
		...
		isIterable$1 = /*@__PURE__*/ requireIsIterable$2();
		return isIterable$1;
	}
	...
	function requireIsIterable () {
		...
		isIterable = /*@__PURE__*/ requireIsIterable$1();
		return isIterable;
	}

	var isIterableExports = requireIsIterable();
	var _isIterable = /*@__PURE__*/getDefaultExportFromCjs(isIterableExports);
	...
	function writable(value) {
	  let start = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : noop$1;
	  ...
	  function subscribe(run) {
	    let invalidate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : noop$1;
	...
	function createEvents(input) {
	  return input.map(event => {
	    ...
	    if (result.allDay) {
	      ...
	      if (!datesEqual(result.end, end) || datesEqual(result.end, result.start) /** @see https://github.com/vkurko/calendar/issues/50 */) {
	        addDay(result.end);
	      }
	    }
	    return result;
	...
	function repositionEvent$1(chunk, longChunks, height) {
	  chunk.top = 0;
	  if (chunk.prev) {
	...
	function viewResources(state) {
	  return derived([state.resources, state.filterResourcesWithEvents, state._events, state._activeRange], _ref3 => {
	    let [$resources, $filterResourcesWithEvents, $_events, $_activeRange] = _ref3;
	...
	function activeRange(state) {
	  return derived([state._currentRange, state.firstDay, state.slotMaxTime, state._dayGrid], _ref4 => {
	    let [$_currentRange, $firstDay, $slotMaxTime, $_dayGrid] = _ref4;
	...
	function currentRange(state) {
	  return derived([state.date, state.duration, state.firstDay], _ref5 => {
	    let [$date, $duration, $firstDay] = _ref5;
	...
	function viewDates(state) {
	  return derived([state._activeRange, state.hiddenDays], _ref6 => {
	    let [$_activeRange, $hiddenDays] = _ref6;
	    let dates = [];
	...
	function viewTitle(state) {
	  return derived([state.date, state._activeRange, state._intlTitle, state._dayGrid], _ref7 => {
	    let [$date, $_activeRange, $_intlTitle, $_dayGrid] = _ref7;
	...
	function create_if_block_5(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      t = text(t_value);
	      attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ctx[3].button + (/*$view*/ctx[7] === /*button*/ctx[25] ? ' ' + /*$theme*/ctx[3].active : '') + " ec-" + /*button*/ctx[25]));
	      add_location(button_1, file$2$4, 52, 8, 1856);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, button_1, anchor);
	      append_dev(button_1, t);
	      if (!mounted) {
	        dispose = listen_dev(button_1, "click", click_handler_1, false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(new_ctx, dirty) {
	      ...
	      if (dirty & /*$theme, $view, buttons*/137 && button_1_class_value !== (button_1_class_value = "" + (/*$theme*/ctx[3].button + (/*$view*/ctx[7] === /*button*/ctx[25] ? ' ' + /*$theme*/ctx[3].active : '') + " ec-" + /*button*/ctx[25]))) {
	...
	function create_if_block_4$1(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      button_1 = element("button");
	      attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ctx[3].button + " ec-" + /*button*/ctx[25] + (/*$customButtons*/ctx[6][/*button*/ctx[25]].active ? ' ' + /*$theme*/ctx[3].active : '')));
	      add_location(button_1, file$2$4, 46, 8, 1578);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, button_1, anchor);
	      if (!mounted) {
	        ...
	        }, false, false, false), action_destroyer(setContent_action = setContent.call(null, button_1, /*$customButtons*/ctx[6][/*button*/ctx[25]].text))];
	        mounted = true;
	      }
	    },
	    p: function update(new_ctx, dirty) {
	      ctx = new_ctx;
	      if (dirty & /*$theme, buttons, $customButtons*/73 && button_1_class_value !== (button_1_class_value = "" + (/*$theme*/ctx[3].button + " ec-" + /*button*/ctx[25] + (/*$customButtons*/ctx[6][/*button*/ctx[25]].active ? ' ' + /*$theme*/ctx[3].active : '')))) {
	        attr_dev(button_1, "class", button_1_class_value);
	      }
	...
	function create_if_block_3$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      button_1 = element("button");
	      t = text(t_value);
	      attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ctx[3].button + " ec-" + /*button*/ctx[25]));
	      button_1.disabled = /*isToday*/ctx[1];
	      add_location(button_1, file$2$4, 40, 8, 1351);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, button_1, anchor);
	      append_dev(button_1, t);
	      if (!mounted) {
	        dispose = listen_dev(button_1, "click", /*click_handler*/ctx[21], false, false, false);
	        mounted = true;
	      }
	    },
	...
	function create_if_block_2$3(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(i, file$2$4, 38, 9, 1259);
	      attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ctx[3].button + " ec-" + /*button*/ctx[25]));
	      ...
	      add_location(button_1, file$2$4, 33, 8, 1087);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, button_1, anchor);
	      append_dev(button_1, i);
	      if (!mounted) {
	        dispose = listen_dev(button_1, "click", /*next*/ctx[19], false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(ctx, dirty) {
	...
	function create_if_block_1$5(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      i = element("i");
	      attr_dev(i, "class", i_class_value = "" + (/*$theme*/ctx[3].icon + " ec-" + /*button*/ctx[25]));
	      add_location(i, file$2$4, 31, 9, 996);
	      attr_dev(button_1, "class", button_1_class_value = "" + (/*$theme*/ctx[3].button + " ec-" + /*button*/ctx[25]));
	      ...
	      add_location(button_1, file$2$4, 26, 8, 824);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, button_1, anchor);
	      append_dev(button_1, i);
	      if (!mounted) {
	        dispose = listen_dev(button_1, "click", /*prev*/ctx[18], false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(ctx, dirty) {
	...
	function create_if_block$1$4(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(h2, file$2$4, 24, 8, 722);
	    },
	    m: function mount(target, anchor) {
	...
	function create_each_block$2$3(ctx) {
	  ...
	  function select_block_type(ctx, dirty) {
	    if (/*button*/ctx[25] == 'title') return create_if_block$1$4;
	    if (/*button*/ctx[25] == 'prev') return create_if_block_1$5;
	    if (/*button*/ctx[25] == 'next') return create_if_block_2$3;
	...
	function instance$3$5($$self, $$props, $$invalidate) {
	  ...
	  return [buttons, isToday, $date, $theme, $_viewTitle, $buttonText, $customButtons, $view, _currentRange, _viewTitle, buttonText, customButtons, date, duration, hiddenDays, theme, view, today, prev, next, $_currentRange, click_handler, click_handler_1];
	}
	...
	const file$1$5 = "packages/core/src/Toolbar.svelte";
	...
	function create_if_block$a(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$1$5, 25, 20, 638);
	    },
	    m: function mount(target, anchor) {
	...
	function create_each_block$1$4(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$1$5, 22, 8, 509);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      for (let i = 0; i < each_blocks.length; i += 1) {
	...
	function create_fragment$2$5(ctx) {
	  ...
	  let nav_class_value;
	  let current;
	  let each_value = ensure_array_like_dev(keys(/*sections*/ctx[0]));
	  let each_blocks = [];
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(nav, file$1$5, 20, 0, 436);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    ...
	    p: function update(ctx, _ref9) {
	      ...
	      if (dirty & /*sections, $theme*/3) {
	        each_value = ensure_array_like_dev(keys(/*sections*/ctx[0]));
	        let i;
	        for (i = 0; i < each_value.length; i += 1) {
	...
	const file$e = "packages/core/src/Calendar.svelte";
	function create_fragment$e(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$e, 140, 0, 3546);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = listen_dev(window, "resize", /*recheckScrollable*/ctx[20], false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(ctx, dirty) {
	...
	function instance$e($$self, $$props, $$invalidate) {
	  ...
	  return [$_scrollable, $theme, $_iClass, $height, $view, $_viewComponent, _viewComponent, _bodyEl, _interaction, _iClass, _events, _queue, _queue2, _scrollable, date, duration, hiddenDays, height, theme, view, recheckScrollable, plugins, options, setOption, getOption, refetchEvents, getEvents, getEventById, addEvent, updateEvent, removeEventById, getView, unselect, dateFromPoint, next, prev];
	}
	...
	let index$7 = class index extends Calendar {
	  destroy() {
	    this.$destroy();
	  }
	  get view() {
	...
	const file$5$2 = "packages/day-grid/src/Header.svelte";
	...
	function create_each_block$4$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(span, file$5$2, 11, 16, 408);
	      ...
	      add_location(div, file$5$2, 10, 12, 308);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      append_dev(div, span);
	...
	let Header$1 = class Header extends SvelteComponentDev {
	  constructor(options) {
	    super(options);
	...
	const file$4$2 = "packages/day-grid/src/Event.svelte";
	function create_fragment$5$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$4$2, 188, 4, 5807);
	      ...
	      add_location(article, file$4$2, 176, 0, 5371);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      if (!mounted) {
	        ...
	        }, false, false, false), listen_dev(article, "keydown", function () {
	          if (is_function(/*onclick*/ctx[7] && keyEnter(/*onclick*/ctx[7]))) (/*onclick*/ctx[7] && keyEnter(/*onclick*/ctx[7])).apply(this, arguments);
	        }, false, false, false), listen_dev(article, "mouseenter", function () {
	        ...
	        }, false, false, false), listen_dev(article, "mouseleave", function () {
	        ...
	        }, false, false, false), listen_dev(article, "pointerdown", function () {
	...
	function instance$5$2($$self, $$props, $$invalidate) {
	  ...
	  function createHandler(fn, display) {
	    return !helperEvent(display) && isFunction(fn) ? jsEvent => fn({
	      event: toEventWithLocalDates(event),
	      el,
	      jsEvent,
	      view: toViewWithLocalDates($_view)
	  ...
	  function createDragHandler(interaction, resize) {
	    return interaction.action ? jsEvent => $_interaction.action.drag(event, jsEvent, resize, inPopup ? $_popupDate : null, [rect(el).top - rect(ancestor(el, 1)).top, dates]) : undefined;
	  }
	  function reposition() {
	    if (!el) {
	      return;
	    }
	    $$invalidate(38, margin = repositionEvent$1(chunk, longChunks, height(el)));
	  ...
	  $$self.$capture_state = () => ({
	    ...
	    toViewWithLocalDates,
	    setContent,
	    repositionEvent: repositionEvent$1,
	  ...
	  return [event, display, $theme, el, classes, style, content, onclick, $_interaction, $eventMouseEnter, $eventMouseLeave, dayMaxEvents, displayEventEnd, eventAllUpdated, eventBackgroundColor, eventTextColor, eventClick, eventColor, eventContent, eventClassNames, eventDidMount, eventMouseEnter, eventMouseLeave, resources, theme, _view, _intlEventTime, _interaction, _iClasses, _hiddenEvents, _popupDate, createHandler, createDragHandler, chunk, longChunks, inPopup, dates, reposition, margin, hidden, $eventClick, $_view, $_intlEventTime, $eventContent, $displayEventEnd, $eventClassNames, $_iClasses, $eventTextColor, $resources, $eventColor, $eventBackgroundColor, article_binding];
	}
	let Event$4 = class Event extends SvelteComponentDev {
	  constructor(options) {
	    super(options);
	...
	const file$3$2 = "packages/day-grid/src/Popup.svelte";
	...
	function create_fragment$4$2(ctx) {
	  ...
	  validate_each_keys(ctx, each_value, get_each_context$3$2, get_key);
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  const block = {
	    ...
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = [action_destroyer(setContent_action = setContent.call(null, time, /*$_intlDayPopover*/ctx[5].format(/*$_popupDate*/ctx[3]))), listen_dev(a, "click", stop_propagation(/*close*/ctx[13]), false, false, true), listen_dev(a, "keydown", keyEnter(/*close*/ctx[13]), false, false, false), action_destroyer(outsideEvent.call(null, div2, 'pointerdown')), listen_dev(div2, "pointerdown", stop_propagation(/*pointerdown_handler*/ctx[15]), false, false, true), listen_dev(div2, "pointerdownoutside", /*handlePointerDownOutside*/ctx[14], false, false, false)];
	        mounted = true;
	      }
	    },
	...
	const file$2$3 = "packages/day-grid/src/Day.svelte";
	...
	function create_if_block_3$1(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$2$3, 109, 8, 3612);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	...
	function create_if_block_2$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$2$3, 115, 8, 3800);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      mount_component(event, div, null);
	...
	function create_if_block$9(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(a, file$2$3, 131, 12, 4336);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, a, anchor);
	      if (!mounted) {
	        dispose = [listen_dev(a, "click", stop_propagation(/*showMore*/ctx[27]), false, false, true), listen_dev(a, "keydown", keyEnter(/*showMore*/ctx[27]), false, false, false), listen_dev(a, "pointerdown", stop_propagation(/*pointerdown_handler*/ctx[37]), false, false, true), action_destroyer(setContent_action = setContent.call(null, a, /*moreLink*/ctx[12]))];
	        mounted = true;
	      }
	    },
	    p: function update(ctx, dirty) {
	...
	function create_fragment$3$4(ctx) {
	  ...
	  let mounted;
	  let dispose;
	  let each_value_1 = ensure_array_like_dev(/*dayBgChunks*/ctx[8]);
	  ...
	  let each_value = ensure_array_like_dev(/*dayChunks*/ctx[5]);
	  const get_key_1 = ctx => /*chunk*/ctx[44].event;
	  validate_each_keys(ctx, each_value, get_each_context$2$2, get_key_1);
	  for (let i = 0; i < each_value.length; i += 1) {
	    let child_ctx = get_each_context$2$2(ctx, each_value, i);
	    let key = get_key_1(child_ctx);
	    each1_lookup.set(key, each_blocks[i] = create_each_block$2$2(key, child_ctx));
	  }
	  let if_block2 = /*showPopup*/ctx[7] && create_if_block_1$4(ctx);
	  let if_block3 = /*hiddenEvents*/ctx[6].size && create_if_block$9(ctx);
	  const block = {
	    c: function create() {
	      div3 = element("div");
	      time = element("time");
	      ...
	      add_location(time, file$2$3, 97, 4, 3235);
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[14].bgEvents);
	      add_location(div0, file$2$3, 102, 4, 3386);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[14].events);
	      add_location(div1, file$2$3, 119, 4, 3916);
	      attr_dev(div2, "class", div2_class_value = /*$theme*/ctx[14].dayFoot);
	      add_location(div2, file$2$3, 127, 4, 4147);
	      attr_dev(div3, "class", div3_class_value = "" + (/*$theme*/ctx[14].day + " " + /*$theme*/ctx[14].weekdays?.[/*date*/ctx[0].getUTCDay()] + (/*isToday*/ctx[9] ? ' ' + /*$theme*/ctx[14].today : '') + (/*otherMonth*/ctx[10] ? ' ' + /*$theme*/ctx[14].otherMonth : '') + (/*highlight*/ctx[11] ? ' ' + /*$theme*/ctx[14].highlight : '')));
	      attr_dev(div3, "role", "cell");
	      add_location(div3, file$2$3, 90, 0, 2906);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = [action_destroyer(setContent_action = setContent.call(null, time, /*$_intlDayCell*/ctx[16].format(/*date*/ctx[0]))), listen_dev(div3, "pointerleave", function () {
	          if (is_function(/*$_interaction*/ctx[15].pointer?.leave)) /*$_interaction*/ctx[15].pointer?.leave.apply(this, arguments);
	        }, false, false, false), listen_dev(div3, "pointerdown", function () {
	    ...
	    p: function update(new_ctx, dirty) {
	      ...
	      if (dirty[0] & /*dayBgChunks*/256) {
	        each_value_1 = ensure_array_like_dev(/*dayBgChunks*/ctx[8]);
	        group_outros();
	        validate_each_keys(ctx, each_value_1, get_each_context_1$5, get_key);
	        each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx, each_value_1, each0_lookup, div0, outro_and_destroy_block, create_each_block_1$5, null, get_each_context_1$5);
	        check_outros();
	      }
	      ...
	      if (dirty[0] & /*dayChunks, longChunks, dates, refs*/8234) {
	        each_value = ensure_array_like_dev(/*dayChunks*/ctx[5]);
	        group_outros();
	        validate_each_keys(ctx, each_value, get_each_context$2$2, get_key_1);
	        each_blocks = update_keyed_each(each_blocks, dirty, get_key_1, 1, ctx, each_value, each1_lookup, div1, outro_and_destroy_block, create_each_block$2$2, null, get_each_context$2$2);
	        check_outros();
	      }
	      ...
	      if (!current || dirty[0] & /*$theme, date, isToday, otherMonth, highlight*/19969 && div3_class_value !== (div3_class_value = "" + (/*$theme*/ctx[14].day + " " + /*$theme*/ctx[14].weekdays?.[/*date*/ctx[0].getUTCDay()] + (/*isToday*/ctx[9] ? ' ' + /*$theme*/ctx[14].today : '') + (/*otherMonth*/ctx[10] ? ' ' + /*$theme*/ctx[14].otherMonth : '') + (/*highlight*/ctx[11] ? ' ' + /*$theme*/ctx[14].highlight : '')))) {
	...
	function instance$3$4($$self, $$props, $$invalidate) {
	  ...
	  $$self.$$.update = () => {
	    ...
	    if ($$self.$$.dirty[0] & /*hiddenEvents*/64 | $$self.$$.dirty[1] & /*$_hiddenEvents, $moreLinkContent*/6) {
	      if ($_hiddenEvents && hiddenEvents.size) {
	        ...
	        if ($moreLinkContent) {
	          $$invalidate(12, moreLink = isFunction($moreLinkContent) ? $moreLinkContent({
	  ...
	  return [date, longChunks, iChunks, dates, el, dayChunks, hiddenEvents, showPopup, dayBgChunks, isToday, otherMonth, highlight, moreLink, refs, $theme, $_interaction, $_intlDayCell, currentDate, highlightedDates, moreLinkContent, theme, _hiddenEvents, _intlDayCell, _popupDate, _popupChunks, _today, _interaction, showMore, chunks, bgChunks, reposition, $_popupDate, $moreLinkContent, $_hiddenEvents, $highlightedDates, $currentDate, $_today, pointerdown_handler, event_binding, div3_binding];
	}
	let Day$4 = class Day extends SvelteComponentDev {
	  constructor(options) {
	    super(options);
	...
	const file$1$4 = "packages/day-grid/src/Week.svelte";
	...
	function create_fragment$2$4(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$1$4, 65, 0, 1908);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = listen_dev(window, "resize", /*reposition*/ctx[14], false, false, false);
	        mounted = true;
	      }
	    },
	...
	function instance$2$4($$self, $$props, $$invalidate) {
	  ...
	  $$self.$capture_state = () => ({
	    ...
	    bgEvent,
	    createEventChunk,
	    prepareEventChunks: prepareEventChunks$1,
	    runReposition,
	    debounce,
	    Day: Day$4,
	    dates,
	  ...
	  return [dates, chunks, bgChunks, longChunks, iChunks, refs, $theme, _events, _iEvents, _hiddenEvents, resources, filterEventsWithResources, hiddenDays, theme, reposition, start, end, $_hiddenEvents, $hiddenDays, $_iEvents, $resources, $filterEventsWithResources, $_events, day_binding];
	}
	...
	const file$d = "packages/day-grid/src/Body.svelte";
	...
	function create_fragment$1$5(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div0, file$d, 28, 4, 715);
	      attr_dev(div1, "class", div1_class_value = "" + (/*$theme*/ctx[2].body + (/*$dayMaxEvents*/ctx[1] === true ? ' ' + /*$theme*/ctx[2].uniform : '')));
	      add_location(div1, file$d, 24, 0, 601);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    ...
	    p: function update(ctx, _ref5) {
	      ...
	      if (!current || dirty & /*$theme, $dayMaxEvents*/6 && div1_class_value !== (div1_class_value = "" + (/*$theme*/ctx[2].body + (/*$dayMaxEvents*/ctx[1] === true ? ' ' + /*$theme*/ctx[2].uniform : '')))) {
	        attr_dev(div1, "class", div1_class_value);
	      }
	    },
	    i: function intro(local) {
	...
	function instance$1$5($$self, $$props, $$invalidate) {
	  ...
	  return [weeks, $dayMaxEvents, $theme, $_bodyEl, _bodyEl, _viewDates, _hiddenEvents, dayMaxEvents, hiddenDays, theme, days, $_viewDates, $hiddenDays, div1_binding];
	}
	let Body$3 = class Body extends SvelteComponentDev {
	  constructor(options) {
	    super(options);
	...
	let View$4 = class View extends SvelteComponentDev {
	  constructor(options) {
	    super(options);
	...
	function create_fragment$3$3(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div0, file$2$2, 94, 4, 2775);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[0].eventBody);
	      add_location(div1, file$2$2, 95, 4, 2825);
	      ...
	      add_location(article, file$2$2, 83, 0, 2409);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	function instance$3$3($$self, $$props, $$invalidate) {
	  ...
	  function createHandler(fn) {
	    return isFunction(fn) ? jsEvent => fn({
	      event: toEventWithLocalDates(event),
	      el,
	      jsEvent,
	      view: toViewWithLocalDates($_view)
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('resources' in $$props) $$invalidate(20, resources = $$props.resources);
	    if ('theme' in $$props) $$invalidate(21, theme = $$props.theme);
	    if ('_view' in $$props) $$invalidate(22, _view = $$props._view);
	    if ('_intlEventTime' in $$props) $$invalidate(23, _intlEventTime = $$props._intlEventTime);
	    if ('_interaction' in $$props) $$invalidate(24, _interaction = $$props._interaction);
	    if ('_tasks' in $$props) _tasks = $$props._tasks;
	    if ('el' in $$props) $$invalidate(1, el = $$props.el);
	    if ('event' in $$props) $$invalidate(27, event = $$props.event);
	  ...
	  return [$theme, el, classes, style, content, onclick, $eventMouseEnter, $eventMouseLeave, $_interaction, displayEventEnd, eventAllUpdated, eventBackgroundColor, eventTextColor, eventColor, eventContent, eventClassNames, eventClick, eventDidMount, eventMouseEnter, eventMouseLeave, resources, theme, _view, _intlEventTime, _interaction, createHandler, chunk, event, $eventClick, $_view, $_intlEventTime, $eventContent, $displayEventEnd, $eventClassNames, $eventTextColor, $resources, $eventColor, $eventBackgroundColor, article_binding];
	}
	...
	const file$1$3 = "packages/list/src/Day.svelte";
	...
	function create_if_block$1$3(ctx) {
	  ...
	  validate_each_keys(ctx, each_value, get_each_context$1$2, get_key);
	  for (let i = 0; i < each_value.length; i += 1) {
	    let child_ctx = get_each_context$1$2(ctx, each_value, i);
	    let key = get_key(child_ctx);
	    each_1_lookup.set(key, each_blocks[i] = create_each_block$1$2(key, child_ctx));
	  }
	  const block = {
	    c: function create() {
	      div = element("div");
	      ...
	      add_location(div, file$1$3, 50, 4, 1365);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      append_dev(div, h4);
	    ...
	    p: function update(new_ctx, dirty) {
	      ...
	      if (dirty & /*chunks*/4) {
	        ...
	        group_outros();
	        validate_each_keys(ctx, each_value, get_each_context$1$2, get_key);
	        each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, div, outro_and_destroy_block, create_each_block$1$2, null, get_each_context$1$2);
	        check_outros();
	      }
	...
	function create_each_block$1$2(key_1, ctx) {
	  let first;
	  let event;
	  let current;
	  event = new Event$3({
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(61:8) {#each chunks as chunk (chunk.event)}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$2$3(ctx) {
	  let if_block_anchor;
	  let current;
	  let if_block = /*chunks*/ctx[2].length && create_if_block$1$3(ctx);
	  const block = {
	    c: function create() {
	      if (if_block) if_block.c();
	      if_block_anchor = empty();
	...
	function instance$2$3($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('resources' in $$props) $$invalidate(15, resources = $$props.resources);
	    if ('filterEventsWithResources' in $$props) $$invalidate(16, filterEventsWithResources = $$props.filterEventsWithResources);
	    if ('highlightedDates' in $$props) $$invalidate(17, highlightedDates = $$props.highlightedDates);
	    if ('theme' in $$props) $$invalidate(18, theme = $$props.theme);
	    if ('el' in $$props) $$invalidate(1, el = $$props.el);
	  ...
	  return [date, el, chunks, isToday, highlight, datetime, $theme, $_interaction, $_intlListDay, $_intlListDaySide, _events, _interaction, _intlListDay, _intlListDaySide, _today, resources, filterEventsWithResources, highlightedDates, theme, $highlightedDates, $_today, $resources, $filterEventsWithResources, $_events, div_binding];
	}
	...
	const file$c = "packages/list/src/Body.svelte";
	...
	function create_if_block$8(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$c, 42, 12, 1386);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      if (!mounted) {
	        dispose = [action_destroyer(setContent_action = setContent.call(null, div, /*content*/ctx[0])), listen_dev(div, "click", /*handleClick*/ctx[12], false, false, false)];
	        mounted = true;
	      }
	    },
	    p: function update(ctx, dirty) {
	...
	function create_each_block$8(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(45:12) {#each $_viewDates as date}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$1$4(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div0, file$c, 38, 4, 1180);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[3].body);
	      add_location(div1, file$c, 37, 0, 1127);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	function instance$1$4($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    if ('_bodyEl' in $$props) $$invalidate(5, _bodyEl = $$props._bodyEl);
	    if ('_events' in $$props) $$invalidate(6, _events = $$props._events);
	    if ('_view' in $$props) $$invalidate(7, _view = $$props._view);
	    if ('_viewDates' in $$props) $$invalidate(8, _viewDates = $$props._viewDates);
	    if ('noEventsClick' in $$props) $$invalidate(9, noEventsClick = $$props.noEventsClick);
	    if ('noEventsContent' in $$props) $$invalidate(10, noEventsContent = $$props.noEventsContent);
	  ...
	  return [content, $_viewDates, noEvents, $theme, $_bodyEl, _bodyEl, _events, _view, _viewDates, noEventsClick, noEventsContent, theme, handleClick, $noEventsContent, $_events, div1_binding];
	}
	...
	function times(state) {
	  return derived([state.slotDuration, state._slotTimeLimits, state._intlSlotLabel], args => createTimes(setMidnight(createDate()), ...args));
	}
	function slotTimeLimits(state) {
	  return derived([state.slotMinTime, state.slotMaxTime, state.flexibleSlotTimeLimits, state._viewDates, state._events], args => createSlotTimeLimits(...args));
	}
	...
	function createAllDayContent(allDayContent) {
	  ...
	  let content;
	  if (allDayContent) {
	    content = isFunction(allDayContent) ? allDayContent({
	      text
	    }) : allDayContent;
	    if (typeof content === 'string') {
	      content = {
	...
	const file$7$1 = "packages/time-grid/src/Section.svelte";
	...
	function create_each_block$5$1(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(time_1, file$7$1, 14, 8, 446);
	    },
	    m: function mount(target, anchor) {
	...
	const file$6$1 = "packages/time-grid/src/Body.svelte";
	...
	function create_each_block$4$1(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$6$1, 36, 20, 896);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	    },
	...
	function instance$7$1($$self, $$props, $$invalidate) {
	  ...
	  return [el, compact, lines, $theme, _bodyEl, _viewDates, _slotTimeLimits, _times, scrollTime, slotDuration, slotHeight, theme, $slotDuration, $scrollTime, $_viewDates, $_times, slots, div1_binding, $$scope];
	}
	...
	const file$5$1 = "packages/time-grid/src/Event.svelte";
	function create_fragment$6$1(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      if (switch_instance) create_component(switch_instance.$$.fragment);
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[2].eventBody);
	      add_location(div, file$5$1, 129, 4, 4376);
	      attr_dev(article, "class", /*classes*/ctx[4]);
	      attr_dev(article, "style", /*style*/ctx[5]);
	      attr_dev(article, "role", article_role_value = /*onclick*/ctx[7] ? 'button' : undefined);
	      attr_dev(article, "tabindex", article_tabindex_value = /*onclick*/ctx[7] ? 0 : undefined);
	      add_location(article, file$5$1, 117, 0, 3932);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	function instance$6$1($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('resources' in $$props) $$invalidate(25, resources = $$props.resources);
	    if ('theme' in $$props) $$invalidate(26, theme = $$props.theme);
	    if ('_view' in $$props) $$invalidate(27, _view = $$props._view);
	    if ('_intlEventTime' in $$props) $$invalidate(28, _intlEventTime = $$props._intlEventTime);
	    if ('_interaction' in $$props) $$invalidate(29, _interaction = $$props._interaction);
	    if ('_iClasses' in $$props) $$invalidate(30, _iClasses = $$props._iClasses);
	    if ('_slotTimeLimits' in $$props) $$invalidate(31, _slotTimeLimits = $$props._slotTimeLimits);
	    if ('_tasks' in $$props) _tasks = $$props._tasks;
	    if ('el' in $$props) $$invalidate(3, el = $$props.el);
	    if ('event' in $$props) $$invalidate(0, event = $$props.event);
	    if ('display' in $$props) $$invalidate(1, display = $$props.display);
	  ...
	  return [event, display, $theme, el, classes, style, content, onclick, $eventMouseEnter, $eventMouseLeave, $_interaction, displayEventEnd, eventAllUpdated, eventBackgroundColor, eventTextColor, eventColor, eventContent, eventClick, eventDidMount, eventClassNames, eventMouseEnter, eventMouseLeave, slotEventOverlap, slotDuration, slotHeight, resources, theme, _view, _intlEventTime, _interaction, _iClasses, _slotTimeLimits, createHandler, createDragHandler, date, chunk, $eventClick, $_view, $_intlEventTime, $eventContent, $displayEventEnd, $eventClassNames, $_iClasses, $slotEventOverlap, $eventTextColor, $resources, $eventColor, $eventBackgroundColor, $slotHeight, $_slotTimeLimits, $slotDuration, article_binding];
	}
	...
	const file$4$1 = "packages/time-grid/src/NowIndicator.svelte";
	function create_fragment$5$1(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$4$1, 17, 0, 424);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	const file$3$1 = "packages/time-grid/src/Day.svelte";
	function get_each_context$3$1(ctx, list, i) {
	  const child_ctx = ctx.slice();
	  child_ctx[37] = list[i];
	  return child_ctx;
	}
	function get_each_context_1$2$1(ctx, list, i) {
	  const child_ctx = ctx.slice();
	  child_ctx[37] = list[i];
	  return child_ctx;
	}
	...
	function create_each_block_1$2$1(key_1, ctx) {
	  let first;
	  let event;
	  let current;
	  event = new Event$1({
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    block,
	    id: create_each_block_1$2$1.name,
	    type: "each",
	...
	function create_fragment$4$1(ctx) {
	  ...
	  validate_each_keys(ctx, each_value_1, get_each_context_1$2$1, get_key);
	  for (let i = 0; i < each_value_1.length; i += 1) {
	    let child_ctx = get_each_context_1$2$1(ctx, each_value_1, i);
	    let key = get_key(child_ctx);
	    each0_lookup.set(key, each_blocks_1[i] = create_each_block_1$2$1(key, child_ctx));
	  }
	  let if_block0 = /*iChunks*/ctx[4][1] && create_if_block_2$1(ctx);
	  let each_value = ensure_array_like_dev(/*chunks*/ctx[2]);
	  const get_key_1 = ctx => /*chunk*/ctx[37].event;
	  validate_each_keys(ctx, each_value, get_each_context$3$1, get_key_1);
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  let if_block1 = /*iChunks*/ctx[4][0] && ! /*iChunks*/ctx[4][0].event.allDay && create_if_block_1$3(ctx);
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div0, file$3$1, 87, 4, 2549);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[7].events);
	      add_location(div1, file$3$1, 92, 4, 2696);
	      attr_dev(div2, "class", div2_class_value = /*$theme*/ctx[7].extra);
	      add_location(div2, file$3$1, 105, 4, 3103);
	      ...
	      attr_dev(div3, "role", "cell");
	      add_location(div3, file$3$1, 80, 0, 2263);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = [listen_dev(div3, "pointerleave", function () {
	    ...
	    p: function update(new_ctx, dirty) {
	      ...
	      if (dirty[0] & /*date, bgChunks*/9) {
	        ...
	        group_outros();
	        validate_each_keys(ctx, each_value_1, get_each_context_1$2$1, get_key);
	        each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx, each_value_1, each0_lookup, div0, outro_and_destroy_block, create_each_block_1$2$1, null, get_each_context_1$2$1);
	        check_outros();
	      }
	...
	function instance$4$1($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('resources' in $$props) $$invalidate(18, resources = $$props.resources);
	    if ('_interaction' in $$props) $$invalidate(19, _interaction = $$props._interaction);
	    if ('_today' in $$props) $$invalidate(20, _today = $$props._today);
	    if ('_slotTimeLimits' in $$props) $$invalidate(21, _slotTimeLimits = $$props._slotTimeLimits);
	    if ('el' in $$props) $$invalidate(1, el = $$props.el);
	    if ('chunks' in $$props) $$invalidate(2, chunks = $$props.chunks);
	    ...
	    if ('resourceFilter' in $$props) $$invalidate(23, resourceFilter = $$props.resourceFilter);
	    if ('start' in $$props) $$invalidate(24, start = $$props.start);
	    if ('end' in $$props) $$invalidate(25, end = $$props.end);
	  };
	  if ($$props && "$$inject" in $$props) {
	    $$self.$inject_state($$props.$$inject);
	  }
	  ...
	  return [date, el, chunks, bgChunks, iChunks, isToday, highlight, $theme, $_interaction, $nowIndicator, _events, _iEvents, highlightedDates, nowIndicator, slotDuration, slotHeight, filterEventsWithResources, theme, resources, _interaction, _today, _slotTimeLimits, resource, resourceFilter, start, end, $_slotTimeLimits, $highlightedDates, $_today, $_iEvents, $_events, $resources, $filterEventsWithResources, div3_binding];
	}
	...
	function create_fragment$3$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      if (switch_instance) create_component(switch_instance.$$.fragment);
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[2].eventBody);
	      add_location(div, file$2$1, 122, 4, 3848);
	      attr_dev(article, "class", /*classes*/ctx[4]);
	      attr_dev(article, "style", /*style*/ctx[5]);
	      attr_dev(article, "role", article_role_value = /*onclick*/ctx[7] ? 'button' : undefined);
	      attr_dev(article, "tabindex", article_tabindex_value = /*onclick*/ctx[7] ? 0 : undefined);
	      add_location(article, file$2$1, 110, 0, 3425);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	function instance$3$2($$self, $$props, $$invalidate) {
	  ...
	  function createDragHandler(interaction, resize) {
	    return interaction.action ? jsEvent => interaction.action.drag(event, jsEvent, resize, null, rect(el).top - rect(ancestor(el, 1)).top) : undefined;
	  }
	  function reposition() {
	    if (!el) {
	      return;
	    }
	    $$invalidate(33, margin = repositionEvent$1(chunk, longChunks, height(el)));
	  }
	  $$self.$$.on_mount.push(function () {
	    if (chunk === undefined && !('chunk' in $$props || $$self.$$.bound[$$self.$$.props['chunk']])) {
	      console.warn("<Event> was created without expected prop 'chunk'");
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('eventMouseEnter' in $$props) $$invalidate(20, eventMouseEnter = $$props.eventMouseEnter);
	    if ('eventMouseLeave' in $$props) $$invalidate(21, eventMouseLeave = $$props.eventMouseLeave);
	    if ('resources' in $$props) $$invalidate(22, resources = $$props.resources);
	    ...
	    if ('content' in $$props) $$invalidate(6, content = $$props.content);
	    if ('timeText' in $$props) timeText = $$props.timeText;
	    if ('margin' in $$props) $$invalidate(33, margin = $$props.margin);
	    if ('display' in $$props) $$invalidate(1, display = $$props.display);
	    if ('onclick' in $$props) $$invalidate(7, onclick = $$props.onclick);
	  };
	  if ($$props && "$$inject" in $$props) {
	  ...
	  return [event, display, $theme, el, classes, style, content, onclick, $eventMouseEnter, $eventMouseLeave, $_interaction, displayEventEnd, eventAllUpdated, eventBackgroundColor, eventTextColor, eventClick, eventColor, eventContent, eventClassNames, eventDidMount, eventMouseEnter, eventMouseLeave, resources, theme, _view, _intlEventTime, _interaction, _iClasses, createHandler, createDragHandler, chunk, longChunks, reposition, margin, $eventClick, $_view, $_intlEventTime, $eventContent, $displayEventEnd, $eventClassNames, $_iClasses, $eventTextColor, $resources, $eventColor, $eventBackgroundColor, article_binding];
	}
	...
	const file$1$2 = "packages/time-grid/src/all-day/Day.svelte";
	...
	function create_each_block_1$1$1(key_1, ctx) {
	  let first;
	  let event;
	  let current;
	  event = new Event$2({
	...
	function create_if_block$1$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      div = element("div");
	      create_component(event.$$.fragment);
	      attr_dev(div, "class", div_class_value = "" + (/*$theme*/ctx[9].events + " " + /*$theme*/ctx[9].preview));
	      add_location(div, file$1$2, 50, 8, 1519);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      mount_component(event, div, null);
	...
	function create_fragment$2$2(ctx) {
	  ...
	  let mounted;
	  let dispose;
	  let each_value_1 = ensure_array_like_dev(/*dayBgChunks*/ctx[5]);
	  ...
	  for (let i = 0; i < each_value_1.length; i += 1) {
	    ...
	    let key = get_key(child_ctx);
	    each0_lookup.set(key, each_blocks_1[i] = create_each_block_1$1$1(key, child_ctx));
	  }
	  ...
	  validate_each_keys(ctx, each_value, get_each_context$2$1, get_key_1);
	  for (let i = 0; i < each_value.length; i += 1) {
	    let child_ctx = get_each_context$2$1(ctx, each_value, i);
	    let key = get_key_1(child_ctx);
	    each1_lookup.set(key, each_blocks[i] = create_each_block$2$1(key, child_ctx));
	  }
	  const block = {
	    c: function create() {
	      div2 = element("div");
	      ...
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[9].bgEvents);
	      add_location(div0, file$1$2, 43, 4, 1279);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[9].events);
	      add_location(div1, file$1$2, 54, 4, 1635);
	      attr_dev(div2, "class", div2_class_value = "" + (/*$theme*/ctx[9].day + " " + /*$theme*/ctx[9].weekdays?.[/*date*/ctx[0].getUTCDay()] + (/*isToday*/ctx[6] ? ' ' + /*$theme*/ctx[9].today : '') + (/*highlight*/ctx[7] ? ' ' + /*$theme*/ctx[9].highlight : '')));
	      attr_dev(div2, "role", "cell");
	      add_location(div2, file$1$2, 36, 0, 993);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = [listen_dev(div2, "pointerleave", function () {
	          if (is_function(/*$_interaction*/ctx[10].pointer?.leave)) /*$_interaction*/ctx[10].pointer?.leave.apply(this, arguments);
	        }, false, false, false), listen_dev(div2, "pointerdown", function () {
	          if (is_function(/*$_interaction*/ctx[10].action?.select)) /*$_interaction*/ctx[10].action?.select.apply(this, arguments);
	        }, false, false, false)];
	        mounted = true;
	      }
	    },
	    p: function update(new_ctx, _ref4) {
	      let [dirty] = _ref4;
	      ctx = new_ctx;
	      if (dirty & /*dayBgChunks*/32) {
	        each_value_1 = ensure_array_like_dev(/*dayBgChunks*/ctx[5]);
	        group_outros();
	        validate_each_keys(ctx, each_value_1, get_each_context_1$1$1, get_key);
	        each_blocks_1 = update_keyed_each(each_blocks_1, dirty, get_key, 1, ctx, each_value_1, each0_lookup, div0, outro_and_destroy_block, create_each_block_1$1$1, null, get_each_context_1$1$1);
	        check_outros();
	      }
	      ...
	      if (dirty & /*dayChunks, longChunks, refs*/274) {
	        ...
	        group_outros();
	        validate_each_keys(ctx, each_value, get_each_context$2$1, get_key_1);
	        each_blocks = update_keyed_each(each_blocks, dirty, get_key_1, 1, ctx, each_value, each1_lookup, div1, outro_and_destroy_block, create_each_block$2$1, null, get_each_context$2$1);
	        check_outros();
	      }
	      if (!current || dirty & /*$theme*/512 && div1_class_value !== (div1_class_value = /*$theme*/ctx[9].events)) {
	        attr_dev(div1, "class", div1_class_value);
	      }
	      if (!current || dirty & /*$theme, date, isToday, highlight*/705 && div2_class_value !== (div2_class_value = "" + (/*$theme*/ctx[9].day + " " + /*$theme*/ctx[9].weekdays?.[/*date*/ctx[0].getUTCDay()] + (/*isToday*/ctx[6] ? ' ' + /*$theme*/ctx[9].today : '') + (/*highlight*/ctx[7] ? ' ' + /*$theme*/ctx[9].highlight : '')))) {
	        attr_dev(div2, "class", div2_class_value);
	      }
	    },
	    i: function intro(local) {
	...
	function instance$2$2($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('iChunks' in $$props) $$invalidate(2, iChunks = $$props.iChunks);
	    if ('resource' in $$props) $$invalidate(17, resource = $$props.resource);
	    if ('highlightedDates' in $$props) $$invalidate(11, highlightedDates = $$props.highlightedDates);
	    if ('theme' in $$props) $$invalidate(12, theme = $$props.theme);
	    if ('_interaction' in $$props) $$invalidate(13, _interaction = $$props._interaction);
	    if ('_today' in $$props) $$invalidate(14, _today = $$props._today);
	    if ('el' in $$props) $$invalidate(3, el = $$props.el);
	    if ('dayChunks' in $$props) $$invalidate(4, dayChunks = $$props.dayChunks);
	    if ('dayBgChunks' in $$props) $$invalidate(5, dayBgChunks = $$props.dayBgChunks);
	    if ('isToday' in $$props) $$invalidate(6, isToday = $$props.isToday);
	    if ('highlight' in $$props) $$invalidate(7, highlight = $$props.highlight);
	    if ('refs' in $$props) $$invalidate(8, refs = $$props.refs);
	  };
	  if ($$props && "$$inject" in $$props) {
	    $$self.$inject_state($$props.$$inject);
	  }
	  ...
	  return [date, longChunks, iChunks, el, dayChunks, dayBgChunks, isToday, highlight, refs, $theme, $_interaction, highlightedDates, theme, _interaction, _today, chunks, bgChunks, resource, reposition, $highlightedDates, $_today, event_binding, div2_binding];
	}
	...
	function create_fragment$1$3(ctx) {
	  ...
	  const block = {
	    ...
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = listen_dev(window, "resize", /*reposition*/ctx[12], false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(ctx, _ref5) {
	...
	function instance$1$3($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('chunks' in $$props) $$invalidate(2, chunks = $$props.chunks);
	    if ('bgChunks' in $$props) $$invalidate(3, bgChunks = $$props.bgChunks);
	    if ('longChunks' in $$props) $$invalidate(4, longChunks = $$props.longChunks);
	    if ('iChunks' in $$props) $$invalidate(5, iChunks = $$props.iChunks);
	    if ('start' in $$props) $$invalidate(13, start = $$props.start);
	    if ('end' in $$props) $$invalidate(14, end = $$props.end);
	    if ('refs' in $$props) $$invalidate(6, refs = $$props.refs);
	    if ('resourceFilter' in $$props) $$invalidate(15, resourceFilter = $$props.resourceFilter);
	    if ('debounceHandle' in $$props) debounceHandle = $$props.debounceHandle;
	  };
	  if ($$props && "$$inject" in $$props) {
	    $$self.$inject_state($$props.$$inject);
	    ...
	    if ($$self.$$.dirty & /*$_events, start, end, resourceFilter, bgChunks, chunks, $hiddenDays*/385036) {
	      {
	        ...
	        prepareEventChunks$1(bgChunks, $hiddenDays);
	        $$invalidate(4, longChunks = prepareEventChunks$1(chunks, $hiddenDays));
	  ...
	  return [dates, resource, chunks, bgChunks, longChunks, iChunks, refs, _events, _iEvents, hiddenDays, resources, filterEventsWithResources, reposition, start, end, resourceFilter, $hiddenDays, $_iEvents, $_events, $resources, $filterEventsWithResources, day_binding];
	}
	...
	const file$b = "packages/time-grid/src/View.svelte";
	...
	function create_fragment$b(ctx) {
	  ...
	  let if_block = /*$allDaySlot*/ctx[4] && create_if_block$7(ctx);
	  body = new Body$1({
	    props: {
	      $$slots: {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      create_component(body.$$.fragment);
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[0].hiddenScroll);
	      add_location(div0, file$b, 23, 4, 852);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[0].header);
	      add_location(div1, file$b, 11, 0, 387);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	const file$1$1 = "packages/resource-time-grid/src/Label.svelte";
	function create_fragment$1$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(span, file$1$1, 47, 0, 1250);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	  ...
	  $$self.$$.update = () => {
	    if ($$self.$$.dirty & /*$resourceLabelContent, resource, date*/448) {
	      ...
	      if ($resourceLabelContent) {
	        $$invalidate(1, content = isFunction($resourceLabelContent) ? $resourceLabelContent({
	          resource,
	          date: date ? toLocalDate(date) : undefined
	        }) : $resourceLabelContent);
	      } else {
	...
	const file$a = "packages/resource-time-grid/src/View.svelte";
	...
	function create_else_block_2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$a, 27, 20, 1123);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	...
	function create_if_block_4(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(19:16) {#if $datesAboveResources}",
	    ctx
	  });
	  return block;
	}
	...
	function create_if_block_2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$a, 32, 20, 1363);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      for (let i = 0; i < each_blocks.length; i += 1) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(32:16) {#if loops[1].length > 1}",
	    ctx
	  });
	  return block;
	}
	...
	function create_if_block_3(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[5].day);
	      attr_dev(div, "role", "columnheader");
	      add_location(div, file$a, 35, 32, 1528);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      mount_component(label, div, null);
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(35:28) {#if $datesAboveResources}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_6(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(34:24) {#each loops[1] as item1}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_5(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div, file$a, 17, 12, 614);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(17:8) {#each loops[0] as item0, i}",
	    ctx
	  });
	  return block;
	}
	...
	function create_if_block_1$2(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(60:16) {#if $datesAboveResources}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_4(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      t = space();
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[5].resource);
	      add_location(div, file$a, 69, 24, 3046);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(69:20) {#each $_viewResources as resource}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_3(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(63:28) {#each $_viewResources as resource}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_2$1(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      t = space();
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[5].resource);
	      add_location(div, file$a, 61, 24, 2685);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      for (let i = 0; i < each_blocks.length; i += 1) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(61:20) {#each $_viewDates as date}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_1$3(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(83:8) {#each loops[1] as item1}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block$6(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      t = space();
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[5].resource);
	      add_location(div, file$a, 81, 4, 3372);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      for (let i = 0; i < each_blocks.length; i += 1) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(81:0) {#each loops[0] as item0}",
	    ctx
	  });
	  return block;
	}
	...
	function create_fragment$a(ctx) {
	  ...
	  let if_block = /*$allDaySlot*/ctx[8] && create_if_block$6(ctx);
	  body = new Body$1({
	    props: {
	      $$slots: {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      create_component(body.$$.fragment);
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[5].hiddenScroll);
	      add_location(div0, file$a, 53, 4, 2408);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[5].header);
	      add_location(div1, file$a, 14, 0, 521);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	function dayTimeLimits(state) {
	  return derived([state.slotMinTime, state.slotMaxTime, state.flexibleSlotTimeLimits, state._viewDates, state._events], _ref => {
	    let [$slotMinTime, $slotMaxTime, $flexibleSlotTimeLimits, $_viewDates, $_events] = _ref;
	    let dayTimeLimits = {};
	    for (let date of $_viewDates) {
	      dayTimeLimits[date.getTime()] = createSlotTimeLimits($slotMinTime, $slotMaxTime, $flexibleSlotTimeLimits, [date], $_events);
	    }
	    return dayTimeLimits;
	  });
	}
	function dayTimes(state) {
	  return derived([state._viewDates, state.slotDuration, state._dayTimeLimits, state._intlSlotLabel], _ref2 => {
	    let [$_viewDates, $slotDuration, $_dayTimeLimits, $_intlSlotLabel] = _ref2;
	    let dayTimes = {};
	    for (let date of $_viewDates) {
	      let time = date.getTime();
	      dayTimes[time] = time in $_dayTimeLimits ? createTimes(date, $slotDuration, $_dayTimeLimits[time], $_intlSlotLabel) : [];
	    }
	    return dayTimes;
	  });
	}
	...
	const file$8 = "packages/resource-timeline/src/Label.svelte";
	function create_fragment$8(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      span = element("span");
	      add_location(span, file$8, 35, 0, 893);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	function instance$8($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    if ('resource' in $$props) $$invalidate(4, resource = $$props.resource);
	    if ('date' in $$props) $$invalidate(5, date = $$props.date);
	    if ('resourceLabelContent' in $$props) $$invalidate(2, resourceLabelContent = $$props.resourceLabelContent);
	    if ('resourceLabelDidMount' in $$props) $$invalidate(3, resourceLabelDidMount = $$props.resourceLabelDidMount);
	    if ('el' in $$props) $$invalidate(0, el = $$props.el);
	    if ('content' in $$props) $$invalidate(1, content = $$props.content);
	  };
	  if ($$props && "$$inject" in $$props) {
	  ...
	  return [el, content, resourceLabelContent, resourceLabelDidMount, resource, date, $resourceLabelContent, span_binding];
	}
	...
	const file$7 = "packages/resource-timeline/src/Expander.svelte";
	...
	function create_each_block$5(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      span = element("span");
	      attr_dev(span, "class", span_class_value = /*$theme*/ctx[1].expander);
	      add_location(span, file$7, 30, 4, 739);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, span, anchor);
	    },
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(30:0) {#each Array(payload.level) as level}",
	    ctx
	  });
	  return block;
	}
	...
	function create_if_block$4(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      if_block.c();
	      attr_dev(button, "class", button_class_value = /*$theme*/ctx[1].button);
	      add_location(button, file$7, 35, 8, 863);
	    },
	    m: function mount(target, anchor) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(35:4) {#if payload.children.length}",
	    ctx
	  });
	  return block;
	}
	...
	function create_if_block_1$1(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(37:12) {#if payload.expanded}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$7(ctx) {
	  ...
	  let span;
	  let span_class_value;
	  let each_value = ensure_array_like_dev(Array(/*payload*/ctx[0].level));
	  let each_blocks = [];
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      if (if_block) if_block.c();
	      attr_dev(span, "class", span_class_value = /*$theme*/ctx[1].expander);
	      add_location(span, file$7, 33, 0, 788);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    ...
	    p: function update(ctx, _ref4) {
	      ...
	      if (dirty & /*$theme, payload*/3) {
	        each_value = ensure_array_like_dev(Array(/*payload*/ctx[0].level));
	        let i;
	        for (i = 0; i < each_value.length; i += 1) {
	...
	function instance$7($$self, $$props, $$invalidate) {
	  ...
	  $$self.$$.on_mount.push(function () {
	    if (resource === undefined && !('resource' in $$props || $$self.$$.bound[$$self.$$.props['resource']])) {
	      console.warn("<Expander> was created without expected prop 'resource'");
	    }
	  });
	  const writable_props = ['resource'];
	  Object.keys($$props).forEach(key => {
	    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Expander> was created with unknown prop '${key}'`);
	  });
	  $$self.$$set = $$props => {
	    if ('resource' in $$props) $$invalidate(5, resource = $$props.resource);
	  };
	  $$self.$capture_state = () => ({
	    getContext,
	    getPayload,
	  ...
	  $$self.$$.update = () => {
	    if ($$self.$$.dirty & /*resource*/32) {
	      $$invalidate(0, payload = getPayload(resource));
	    }
	  };
	  return [payload, $theme, resources, theme, handleClick, resource];
	}
	...
	const file$6 = "packages/resource-timeline/src/Sidebar.svelte";
	...
	function create_if_block$3(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(21:16) {#if $_nestedResources}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block$4(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      create_component(label.$$.fragment);
	      t1 = space();
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[1].resource);
	      set_style(div, "flex-basis", max(/*$_resHs*/ctx[4].get(/*resource*/ctx[14]) ?? 0, 64) + "px");
	      attr_dev(div, "role", "rowheader");
	      add_location(div, file$6, 19, 12, 643);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(19:8) {#each $_viewResources as resource}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$6(ctx) {
	  ...
	  let div2_class_value;
	  let current;
	  let each_value = ensure_array_like_dev(/*$_viewResources*/ctx[3]);
	  let each_blocks = [];
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      add_location(div0, file$6, 16, 4, 450);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[1].content);
	      add_location(div1, file$6, 17, 4, 532);
	      attr_dev(div2, "class", div2_class_value = /*$theme*/ctx[1].sidebar);
	      add_location(div2, file$6, 15, 0, 415);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    ...
	    p: function update(ctx, _ref5) {
	      ...
	      if (dirty & /*$theme, $_resHs, $_viewResources, $_nestedResources*/58) {
	        each_value = ensure_array_like_dev(/*$_viewResources*/ctx[3]);
	        let i;
	        for (i = 0; i < each_value.length; i += 1) {
	...
	function instance$6($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    if ('_viewResources' in $$props) $$invalidate(6, _viewResources = $$props._viewResources);
	    if ('_headerEl' in $$props) $$invalidate(7, _headerEl = $$props._headerEl);
	    if ('_resHs' in $$props) $$invalidate(8, _resHs = $$props._resHs);
	    if ('_sidebarEl' in $$props) $$invalidate(9, _sidebarEl = $$props._sidebarEl);
	    if ('_nestedResources' in $$props) $$invalidate(10, _nestedResources = $$props._nestedResources);
	    if ('theme' in $$props) $$invalidate(11, theme = $$props.theme);
	  ...
	  return [titleHeight, $theme, $_sidebarEl, $_viewResources, $_resHs, $_nestedResources, _viewResources, _headerEl, _resHs, _sidebarEl, _nestedResources, theme, div1_binding];
	}
	...
	const file$5 = "packages/resource-timeline/src/Header.svelte";
	...
	function create_else_block(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      div = element("div");
	      time_1 = element("time");
	      attr_dev(time_1, "datetime", time_1_datetime_value = toISOString(/*date*/ctx[15], 10));
	      attr_dev(time_1, "aria-label", time_1_aria_label_value = /*$_intlDayHeaderAL*/ctx[4].format(/*date*/ctx[15]));
	      add_location(time_1, file$5, 31, 28, 1473);
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[0].time);
	      attr_dev(div, "role", "columnheader");
	      add_location(div, file$5, 30, 24, 1397);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	    ...
	    p: function update(new_ctx, dirty) {
	      ...
	      if (dirty & /*$_intlDayHeaderAL, $_viewDates*/20 && time_1_aria_label_value !== (time_1_aria_label_value = /*$_intlDayHeaderAL*/ctx[4].format(/*date*/ctx[15]))) {
	        attr_dev(time_1, "aria-label", time_1_aria_label_value);
	      }
	...
	function create_if_block$2(ctx) {
	  ...
	  let mounted;
	  let dispose;
	  let each_value_1 = ensure_array_like_dev(/*$_dayTimes*/ctx[6][/*date*/ctx[15].getTime()]);
	  let each_blocks = [];
	  for (let i = 0; i < each_value_1.length; i += 1) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      attr_dev(time_1, "datetime", time_1_datetime_value = toISOString(/*date*/ctx[15], 10));
	      attr_dev(time_1, "aria-label", time_1_aria_label_value = /*$_intlDayHeaderAL*/ctx[4].format(/*date*/ctx[15]));
	      add_location(time_1, file$5, 13, 24, 589);
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[0].dayHead);
	      add_location(div0, file$5, 12, 20, 534);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[0].times);
	      add_location(div1, file$5, 19, 20, 886);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div0, anchor);
	      append_dev(div0, time_1);
	      insert_dev(target, t, anchor);
	      insert_dev(target, div1, anchor);
	      for (let i = 0; i < each_blocks.length; i += 1) {
	        if (each_blocks[i]) {
	    ...
	    p: function update(new_ctx, dirty) {
	      ...
	      if (dirty & /*$theme, $_dayTimes, $_viewDates*/69) {
	        each_value_1 = ensure_array_like_dev(/*$_dayTimes*/ctx[6][/*date*/ctx[15].getTime()]);
	        let i;
	        for (i = 0; i < each_value_1.length; i += 1) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(12:16) {#if toSeconds($slotDuration)}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_1$2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      time_1 = element("time");
	      t = space();
	      attr_dev(time_1, "datetime", time_1_datetime_value = /*time*/ctx[18][0]);
	      add_location(time_1, file$5, 22, 32, 1090);
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[0].time);
	      attr_dev(div, "role", "columnheader");
	      add_location(div, file$5, 21, 28, 1010);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      append_dev(div, time_1);
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(21:24) {#each $_dayTimes[date.getTime()] as time}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block$3(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      if_block.c();
	      t = space();
	      attr_dev(div, "class", div_class_value = "" + (/*$theme*/ctx[0].day + " " + /*$theme*/ctx[0].weekdays?.[/*date*/ctx[15].getUTCDay()]));
	      add_location(div, file$5, 10, 12, 402);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      if_block.m(div, null);
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(10:8) {#each $_viewDates as date}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$5(ctx) {
	  ...
	  let div1_class_value;
	  let div2_class_value;
	  let each_value = ensure_array_like_dev(/*$_viewDates*/ctx[2]);
	  let each_blocks = [];
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[0].days);
	      attr_dev(div0, "role", "row");
	      add_location(div0, file$5, 8, 4, 315);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[0].hiddenScroll);
	      add_location(div1, file$5, 41, 4, 1842);
	      attr_dev(div2, "class", div2_class_value = /*$theme*/ctx[0].header);
	      add_location(div2, file$5, 7, 0, 258);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    ...
	    p: function update(ctx, _ref6) {
	      ...
	      if (dirty & /*$theme, $_viewDates, $_dayTimes, $_intlDayHeaderAL, $_intlDayHeader, $slotDuration*/125) {
	        each_value = ensure_array_like_dev(/*$_viewDates*/ctx[2]);
	        let i;
	        for (i = 0; i < each_value.length; i += 1) {
	...
	function instance$5($$self, $$props, $$invalidate) {
	  ...
	  validate_store(_dayTimes, '_dayTimes');
	  ...
	  $$self.$inject_state = $$props => {
	    if ('_headerEl' in $$props) $$invalidate(7, _headerEl = $$props._headerEl);
	    if ('_intlDayHeader' in $$props) $$invalidate(8, _intlDayHeader = $$props._intlDayHeader);
	    if ('_intlDayHeaderAL' in $$props) $$invalidate(9, _intlDayHeaderAL = $$props._intlDayHeaderAL);
	    if ('_dayTimes' in $$props) $$invalidate(10, _dayTimes = $$props._dayTimes);
	    if ('_viewDates' in $$props) $$invalidate(11, _viewDates = $$props._viewDates);
	    if ('slotDuration' in $$props) $$invalidate(12, slotDuration = $$props.slotDuration);
	    if ('theme' in $$props) $$invalidate(13, theme = $$props.theme);
	  };
	  if ($$props && "$$inject" in $$props) {
	    $$self.$inject_state($$props.$$inject);
	  }
	  return [$theme, $_headerEl, $_viewDates, $slotDuration, $_intlDayHeaderAL, $_intlDayHeader, $_dayTimes, _headerEl, _intlDayHeader, _intlDayHeaderAL, _dayTimes, _viewDates, slotDuration, theme, div2_binding];
	}
	...
	function getSlotTimeLimits($_dayTimeLimits, date) {
	  return $_dayTimeLimits[date.getTime()] ?? {
	...
	const file$4 = "packages/resource-timeline/src/Event.svelte";
	...
	function create_if_block$1$1(ctx) {
	  ...
	  if (switch_value) {
	    switch_instance = construct_svelte_component_dev(switch_value, switch_props(ctx));
	    switch_instance.$on("pointerdown", function () {
	      if (is_function(/*createDragHandler*/ctx[32](/*$_interaction*/ctx[11], 'x'))) /*createDragHandler*/ctx[32](/*$_interaction*/ctx[11], 'x').apply(this, arguments);
	    });
	  }
	  const block = {
	    c: function create() {
	      ...
	      t = space();
	      if (switch_instance) create_component(switch_instance.$$.fragment);
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[3].eventBody);
	      add_location(div, file$4, 144, 8, 4591);
	      attr_dev(article, "class", /*classes*/ctx[5]);
	      attr_dev(article, "style", /*style*/ctx[6]);
	      attr_dev(article, "role", article_role_value = /*onclick*/ctx[8] ? 'button' : undefined);
	      attr_dev(article, "tabindex", article_tabindex_value = /*onclick*/ctx[8] ? 0 : undefined);
	      add_location(article, file$4, 132, 4, 4099);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, article, anchor);
	      append_dev(article, div);
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = [action_destroyer(setContent_action = setContent.call(null, div, /*content*/ctx[7])), listen_dev(article, "click", function () {
	...
	function create_fragment$4(ctx) {
	  let if_block_anchor;
	  let current;
	  let if_block = /*width*/ctx[2] > 0 && create_if_block$1$1(ctx);
	  const block = {
	    c: function create() {
	      if (if_block) if_block.c();
	      if_block_anchor = empty();
	...
	function instance$4($$self, $$props, $$invalidate) {
	  ...
	  function createDragHandler(interaction, resize) {
	    return interaction.action ? jsEvent => interaction.action.drag(event, jsEvent, resize, null, [margin, resource]) : undefined;
	  }
	  function reposition() {
	    if (!el) {
	      return 0;
	  ...
	  const writable_props = ['chunk', 'dayChunks', 'longChunks', 'resource'];
	  Object.keys($$props).forEach(key => {
	    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Event> was created with unknown prop '${key}'`);
	  });
	  function article_binding($$value) {
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('eventColor' in $$props) $$invalidate(16, eventColor = $$props.eventColor);
	    if ('eventContent' in $$props) $$invalidate(17, eventContent = $$props.eventContent);
	    if ('eventClick' in $$props) $$invalidate(18, eventClick = $$props.eventClick);
	    if ('eventDidMount' in $$props) $$invalidate(19, eventDidMount = $$props.eventDidMount);
	    if ('eventClassNames' in $$props) $$invalidate(20, eventClassNames = $$props.eventClassNames);
	    if ('eventMouseEnter' in $$props) $$invalidate(21, eventMouseEnter = $$props.eventMouseEnter);
	    if ('eventMouseLeave' in $$props) $$invalidate(22, eventMouseLeave = $$props.eventMouseLeave);
	    if ('resources' in $$props) $$invalidate(23, resources = $$props.resources);
	    if ('slotDuration' in $$props) $$invalidate(24, slotDuration = $$props.slotDuration);
	    if ('slotWidth' in $$props) $$invalidate(25, slotWidth = $$props.slotWidth);
	    if ('theme' in $$props) $$invalidate(26, theme = $$props.theme);
	    if ('_view' in $$props) $$invalidate(27, _view = $$props._view);
	    if ('_intlEventTime' in $$props) $$invalidate(28, _intlEventTime = $$props._intlEventTime);
	    if ('_interaction' in $$props) $$invalidate(29, _interaction = $$props._interaction);
	    ...
	    if ($$self.$$.dirty[0] & /*event, width, style, display, $theme*/79 | $$self.$$.dirty[1] & /*chunk, $slotWidth, $resources, $eventBackgroundColor, $eventColor, $eventTextColor, margin, resource, $_iClasses, $eventClassNames, $_view*/1041060) {
	      {
	        ...
	        // Class
	        $$invalidate(5, classes = [bgEvent(display) ? $theme.bgEvent : $theme.event, ...$_iClasses([], event), ...createEventClasses($eventClassNames, event, $_view)].join(' '));
	      }
	    }
	  ...
	  return [event, display, width, $theme, el, classes, style, content, onclick, $eventMouseEnter, $eventMouseLeave, $_interaction, displayEventEnd, eventAllUpdated, eventBackgroundColor, eventTextColor, eventColor, eventContent, eventClick, eventDidMount, eventClassNames, eventMouseEnter, eventMouseLeave, resources, slotDuration, slotWidth, theme, _view, _intlEventTime, _interaction, _iClasses, createHandler, createDragHandler, chunk, dayChunks, longChunks, resource, reposition, margin, $eventClick, $_view, $_intlEventTime, $eventContent, $displayEventEnd, $eventClassNames, $_iClasses, $eventTextColor, $resources, $eventColor, $eventBackgroundColor, $slotWidth, article_binding];
	}
	...
	const file$3 = "packages/resource-timeline/src/Day.svelte";
	...
	// (86:8) {#each dayBgChunks as chunk (chunk.event)}
	function create_each_block_1$1(key_1, ctx) {
	  ...
	  const block = {
	    ...
	    p: function update(new_ctx, dirty) {
	      ctx = new_ctx;
	      const event_changes = {};
	      if (dirty[0] & /*dayBgChunks*/256) event_changes.chunk = /*chunk*/ctx[34];
	      event.$set(event_changes);
	    },
	    i: function intro(local) {
	      if (current) return;
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(86:8) {#each dayBgChunks as chunk (chunk.event)}",
	    ctx
	  });
	  return block;
	}

	// (90:8) {#if iChunks[pointerIdx] && chunkIntersects(iChunks[pointerIdx])}
	function create_if_block_1(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(90:8) {#if iChunks[pointerIdx] && chunkIntersects(iChunks[pointerIdx])}",
	    ctx
	  });
	  return block;
	}

	// (93:8) {#each dayChunks as chunk, i (chunk.event)}
	function create_each_block$2(key_1, ctx) {
	  let first;
	  let event;
	  let i = /*i*/ctx[36];
	  let current;
	  const assign_event = () => /*event_binding*/ctx[30](event, i);
	  const unassign_event = () => /*event_binding*/ctx[30](null, i);
	  let event_props = {
	    chunk: /*chunk*/ctx[34],
	  ...
	  const block = {
	    ...
	    p: function update(new_ctx, dirty) {
	      ...
	      const event_changes = {};
	      if (dirty[0] & /*dayChunks*/128) event_changes.chunk = /*chunk*/ctx[34];
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(93:8) {#each dayChunks as chunk, i (chunk.event)}",
	    ctx
	  });
	  return block;
	}

	// (97:8) {#if iChunks[0] && chunkIntersects(iChunks[0])}
	function create_if_block$5(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "if",
	    source: "(97:8) {#if iChunks[0] && chunkIntersects(iChunks[0])}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$3$1(ctx) {
	  ...
	  let each0_lookup = new Map();
	  let t0;
	  let show_if_1 = /*iChunks*/ctx[3][/*pointerIdx*/ctx[13]] && /*chunkIntersects*/ctx[23](/*iChunks*/ctx[3][/*pointerIdx*/ctx[13]]);
	  let t1;
	  let each_blocks = [];
	  let each1_lookup = new Map();
	  let t2;
	  let show_if = /*iChunks*/ctx[3][0] && /*chunkIntersects*/ctx[23](/*iChunks*/ctx[3][0]);
	  let div0_class_value;
	  let div1_class_value;
	  let current;
	  let mounted;
	  let dispose;
	  let each_value_1 = ensure_array_like_dev(/*dayBgChunks*/ctx[8]);
	  const get_key = ctx => /*chunk*/ctx[34].event;
	  ...
	  let each_value = ensure_array_like_dev(/*dayChunks*/ctx[7]);
	  const get_key_1 = ctx => /*chunk*/ctx[34].event;
	  ...
	  const block = {
	    c: function create() {
	      ...
	      t2 = space();
	      if (if_block1) if_block1.c();
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[14].events);
	      add_location(div0, file$3, 84, 4, 2334);
	      attr_dev(div1, "class", div1_class_value = "" + (/*$theme*/ctx[14].day + " " + /*$theme*/ctx[14].weekdays?.[/*date*/ctx[0].getUTCDay()] + (/*isToday*/ctx[9] ? ' ' + /*$theme*/ctx[14].today : '') + (/*highlight*/ctx[10] ? ' ' + /*$theme*/ctx[14].highlight : '')));
	      set_style(div1, "flex-grow", /*allDay*/ctx[5] ? null : ceil((toSeconds(/*slotTimeLimits*/ctx[12].max) - toSeconds(/*slotTimeLimits*/ctx[12].min)) / toSeconds(/*$slotDuration*/ctx[6])));
	      attr_dev(div1, "role", "cell");
	      add_location(div1, file$3, 76, 0, 1910);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = [listen_dev(div1, "pointerleave", function () {
	          if (is_function(/*$_interaction*/ctx[15].pointer?.leave)) /*$_interaction*/ctx[15].pointer?.leave.apply(this, arguments);
	        }, false, false, false), listen_dev(div1, "pointerdown", function () {
	          if (is_function(/*$_interaction*/ctx[15].action?.select)) /*$_interaction*/ctx[15].action?.select.apply(this, arguments);
	        }, false, false, false)];
	        mounted = true;
	      }
	    ...
	    p: function update(new_ctx, dirty) {
	      ...
	      if (dirty[0] & /*iChunks, pointerIdx*/8200) show_if_1 = /*iChunks*/ctx[3][/*pointerIdx*/ctx[13]] && /*chunkIntersects*/ctx[23](/*iChunks*/ctx[3][/*pointerIdx*/ctx[13]]);
	      if (show_if_1) {
	        if (if_block0) {
	          if_block0.p(ctx, dirty);
	          if (dirty[0] & /*iChunks, pointerIdx*/8200) {
	            transition_in(if_block0, 1);
	          }
	        } else {
	      ...
	      if (dirty[0] & /*dayChunks, longChunks, resource, refs*/2182) {
	        each_value = ensure_array_like_dev(/*dayChunks*/ctx[7]);
	        group_outros();
	        validate_each_keys(ctx, each_value, get_each_context$2, get_key_1);
	      ...
	      if (dirty[0] & /*iChunks*/8) show_if = /*iChunks*/ctx[3][0] && /*chunkIntersects*/ctx[23](/*iChunks*/ctx[3][0]);
	      if (show_if) {
	        if (if_block1) {
	          if_block1.p(ctx, dirty);
	      ...
	      if (!current || dirty[0] & /*$theme, date, isToday, highlight*/17921 && div1_class_value !== (div1_class_value = "" + (/*$theme*/ctx[14].day + " " + /*$theme*/ctx[14].weekdays?.[/*date*/ctx[0].getUTCDay()] + (/*isToday*/ctx[9] ? ' ' + /*$theme*/ctx[14].today : '') + (/*highlight*/ctx[10] ? ' ' + /*$theme*/ctx[14].highlight : '')))) {
	        attr_dev(div1, "class", div1_class_value);
	      }
	      if (!current || dirty[0] & /*allDay, slotTimeLimits, $slotDuration*/4192) {
	        set_style(div1, "flex-grow", /*allDay*/ctx[5] ? null : ceil((toSeconds(/*slotTimeLimits*/ctx[12].max) - toSeconds(/*slotTimeLimits*/ctx[12].min)) / toSeconds(/*$slotDuration*/ctx[6])));
	      }
	    },
	    i: function intro(local) {
	...
	function instance$3$1($$self, $$props, $$invalidate) {
	  ...
	  validate_store(slotWidth, 'slotWidth');
	  component_subscribe($$self, slotWidth, value => $$invalidate(32, $slotWidth = value));
	  validate_store(theme, 'theme');
	  component_subscribe($$self, theme, value => $$invalidate(14, $theme = value));
	  validate_store(_interaction, '_interaction');
	  component_subscribe($$self, _interaction, value => $$invalidate(15, $_interaction = value));
	  validate_store(_today, '_today');
	  component_subscribe($$self, _today, value => $$invalidate(28, $_today = value));
	  validate_store(_dayTimeLimits, '_dayTimeLimits');
	  ...
	  function dateFromPoint(x, y) {
	    ...
	    return {
	      allDay,
	      date: allDay ? cloneDate(date) : addDuration(addDuration(cloneDate(date), slotTimeLimits.min), $slotDuration, floor(x / $slotWidth)),
	      resource,
	      dayEl: el
	    };
	  }
	  ...
	  $$self.$$.on_mount.push(function () {
	    ...
	    if (resource === undefined && !('resource' in $$props || $$self.$$.bound[$$self.$$.props['resource']])) {
	      console.warn("<Day> was created without expected prop 'resource'");
	    }
	    if (chunks === undefined && !('chunks' in $$props || $$self.$$.bound[$$self.$$.props['chunks']])) {
	      console.warn("<Day> was created without expected prop 'chunks'");
	    }
	  ...
	  const writable_props = ['date', 'resource', 'chunks', 'bgChunks', 'longChunks', 'iChunks'];
	  Object.keys($$props).forEach(key => {
	    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Day> was created with unknown prop '${key}'`);
	  });
	  function event_binding($$value, i) {
	  ...
	  $$self.$$set = $$props => {
	    if ('date' in $$props) $$invalidate(0, date = $$props.date);
	    if ('resource' in $$props) $$invalidate(1, resource = $$props.resource);
	    if ('chunks' in $$props) $$invalidate(24, chunks = $$props.chunks);
	    if ('bgChunks' in $$props) $$invalidate(25, bgChunks = $$props.bgChunks);
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('slotDuration' in $$props) $$invalidate(17, slotDuration = $$props.slotDuration);
	    if ('slotWidth' in $$props) $$invalidate(18, slotWidth = $$props.slotWidth);
	    if ('theme' in $$props) $$invalidate(19, theme = $$props.theme);
	    if ('_interaction' in $$props) $$invalidate(20, _interaction = $$props._interaction);
	    if ('_today' in $$props) $$invalidate(21, _today = $$props._today);
	    if ('_dayTimeLimits' in $$props) $$invalidate(22, _dayTimeLimits = $$props._dayTimeLimits);
	    if ('el' in $$props) $$invalidate(4, el = $$props.el);
	    if ('dayChunks' in $$props) $$invalidate(7, dayChunks = $$props.dayChunks);
	    if ('dayBgChunks' in $$props) $$invalidate(8, dayBgChunks = $$props.dayBgChunks);
	    if ('isToday' in $$props) $$invalidate(9, isToday = $$props.isToday);
	    if ('highlight' in $$props) $$invalidate(10, highlight = $$props.highlight);
	    if ('refs' in $$props) $$invalidate(11, refs = $$props.refs);
	    if ('slotTimeLimits' in $$props) $$invalidate(12, slotTimeLimits = $$props.slotTimeLimits);
	    if ('allDay' in $$props) $$invalidate(5, allDay = $$props.allDay);
	    if ('pointerIdx' in $$props) $$invalidate(13, pointerIdx = $$props.pointerIdx);
	  };
	  if ($$props && "$$inject" in $$props) {
	    $$self.$inject_state($$props.$$inject);
	  }
	  $$self.$$.update = () => {
	    if ($$self.$$.dirty[0] & /*$_dayTimeLimits, date*/536870913) {
	      $$invalidate(12, slotTimeLimits = getSlotTimeLimits($_dayTimeLimits, date));
	    }
	    ...
	    if ($$self.$$.dirty[0] & /*chunks*/16777216) {
	      $$invalidate(7, dayChunks = chunks.filter(chunkIntersects));
	    }
	    if ($$self.$$.dirty[0] & /*bgChunks, allDay*/33554464) {
	  ...
	  return [date, resource, longChunks, iChunks, el, allDay, $slotDuration, dayChunks, dayBgChunks, isToday, highlight, refs, slotTimeLimits, pointerIdx, $theme, $_interaction, highlightedDates, slotDuration, slotWidth, theme, _interaction, _today, _dayTimeLimits, chunkIntersects, chunks, bgChunks, reposition, $highlightedDates, $_today, $_dayTimeLimits, event_binding, div1_binding];
	}
	...
	const file$2 = "packages/resource-timeline/src/Days.svelte";
	...
	// (70:4) {#each $_viewDates as date, i}
	function create_each_block$1(ctx) {
	  ...
	  const block = {
	    ...
	    p: function update(ctx, dirty) {
	      ...
	      const day_changes = {};
	      if (dirty & /*$_viewDates*/8) day_changes.date = /*date*/ctx[27];
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(70:4) {#each $_viewDates as date, i}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$2$1(ctx) {
	  ...
	  let mounted;
	  let dispose;
	  let each_value = ensure_array_like_dev(/*$_viewDates*/ctx[3]);
	  let each_blocks = [];
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[8].days);
	      set_style(div, "flex-basis", max(/*height*/ctx[7], 64) + "px");
	      attr_dev(div, "role", "row");
	      add_location(div, file$2, 68, 0, 2306);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = listen_dev(window, "resize", /*reposition*/ctx[16], false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(ctx, _ref7) {
	      ...
	      if (dirty & /*$_viewDates, resource, chunks, bgChunks, longChunks, iChunks, refs*/127) {
	        each_value = ensure_array_like_dev(/*$_viewDates*/ctx[3]);
	        let i;
	        for (i = 0; i < each_value.length; i += 1) {
	...
	function instance$2$1($$self, $$props, $$invalidate) {
	  ...
	  component_subscribe($$self, _events, value => $$invalidate(22, $_events = value));
	  validate_store(_iEvents, '_iEvents');
	  component_subscribe($$self, _iEvents, value => $$invalidate(21, $_iEvents = value));
	  validate_store(_resHs, '_resHs');
	  component_subscribe($$self, _resHs, value => $$invalidate(24, $_resHs = value));
	  validate_store(_dayTimeLimits, '_dayTimeLimits');
	  component_subscribe($$self, _dayTimeLimits, value => $$invalidate(20, $_dayTimeLimits = value));
	  validate_store(slotDuration, 'slotDuration');
	  ...
	  $$self.$$.on_mount.push(function () {
	    if (resource === undefined && !('resource' in $$props || $$self.$$.bound[$$self.$$.props['resource']])) {
	      console.warn("<Days> was created without expected prop 'resource'");
	    }
	  });
	  const writable_props = ['resource'];
	  Object.keys($$props).forEach(key => {
	    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Days> was created with unknown prop '${key}'`);
	  });
	  function day_binding($$value, i) {
	    binding_callbacks[$$value ? 'unshift' : 'push'](() => {
	      refs[i] = $$value;
	  ...
	  $$self.$inject_state = $$props => {
	    if ('resource' in $$props) $$invalidate(0, resource = $$props.resource);
	    if ('_viewDates' in $$props) $$invalidate(9, _viewDates = $$props._viewDates);
	    if ('_events' in $$props) $$invalidate(10, _events = $$props._events);
	    if ('_iEvents' in $$props) $$invalidate(11, _iEvents = $$props._iEvents);
	    if ('_queue2' in $$props) _queue2 = $$props._queue2;
	    if ('_resHs' in $$props) $$invalidate(12, _resHs = $$props._resHs);
	    if ('_dayTimeLimits' in $$props) $$invalidate(13, _dayTimeLimits = $$props._dayTimeLimits);
	    if ('slotDuration' in $$props) $$invalidate(14, slotDuration = $$props.slotDuration);
	    if ('theme' in $$props) $$invalidate(15, theme = $$props.theme);
	    if ('chunks' in $$props) $$invalidate(1, chunks = $$props.chunks);
	    if ('bgChunks' in $$props) $$invalidate(2, bgChunks = $$props.bgChunks);
	    if ('longChunks' in $$props) $$invalidate(4, longChunks = $$props.longChunks);
	    if ('iChunks' in $$props) $$invalidate(5, iChunks = $$props.iChunks);
	    if ('start' in $$props) $$invalidate(17, start = $$props.start);
	    if ('end' in $$props) $$invalidate(18, end = $$props.end);
	    if ('refs' in $$props) $$invalidate(6, refs = $$props.refs);
	  ...
	  $$self.$$.update = () => {
	    if ($$self.$$.dirty & /*$_viewDates, $_dayTimeLimits*/1048584) {
	      {
	        $$invalidate(17, start = $_viewDates[0]);
	        let slotTimeLimits = getSlotTimeLimits($_dayTimeLimits, $_viewDates.at(-1));
	        $$invalidate(18, end = slotTimeLimits.max.seconds > DAY_IN_SECONDS ? addDuration(cloneDate($_viewDates.at(-1)), slotTimeLimits.max) : addDay(/** @see https://github.com/vkurko/calendar/issues/333 */cloneDate($_viewDates.at(-1))));
	      }
	    }
	    if ($$self.$$.dirty & /*$_events, start, end, resource, bgChunks, chunks, $_viewDates, $_dayTimeLimits, $slotDuration*/6160399) {
	      {
	        $$invalidate(1, chunks = []);
	        $$invalidate(2, bgChunks = []);
	        for (let event of $_events) {
	        ...
	        $$invalidate(4, longChunks = prepareEventChunks(chunks, $_viewDates, $_dayTimeLimits, $slotDuration));

	        // Run reposition only when events get changed
	        reposition();
	      }
	    }
	    if ($$self.$$.dirty & /*$_iEvents, start, end, resource, $_viewDates, $_dayTimeLimits, $slotDuration*/4063241) {
	      $$invalidate(5, iChunks = $_iEvents.map(event => {
	        let chunk;
	  ...
	  return [resource, chunks, bgChunks, $_viewDates, longChunks, iChunks, refs, height, $theme, _viewDates, _events, _iEvents, _resHs, _dayTimeLimits, slotDuration, theme, reposition, start, end, $slotDuration, $_dayTimeLimits, $_iEvents, $_events, day_binding];
	}
	...
	const file$1 = "packages/resource-timeline/src/Body.svelte";
	...
	function create_each_block_2(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      div = element("div");
	      attr_dev(div, "class", div_class_value = /*$theme*/ctx[2].line);
	      add_location(div, file$1, 39, 20, 1148);
	    },
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	    },
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(39:16) {#each $_dayTimes[date.getTime()] as time}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block_1(ctx) {
	  let each_1_anchor;
	  let each_value_2 = ensure_array_like_dev(/*$_dayTimes*/ctx[3][/*date*/ctx[29].getTime()]);
	  let each_blocks = [];
	  for (let i = 0; i < each_value_2.length; i += 1) {
	  ...
	  const block = {
	    ...
	    p: function update(ctx, dirty) {
	      if (dirty[0] & /*$theme, $_dayTimes, $_viewDates*/14) {
	        each_value_2 = ensure_array_like_dev(/*$_dayTimes*/ctx[3][/*date*/ctx[29].getTime()]);
	        let i;
	        for (i = 0; i < each_value_2.length; i += 1) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(38:12) {#each $_viewDates as date}",
	    ctx
	  });
	  return block;
	}
	...
	function create_each_block(ctx) {
	  ...
	  dispatch_dev("SvelteRegisterBlock", {
	    ...
	    type: "each",
	    source: "(44:8) {#each $_viewResources as resource}",
	    ctx
	  });
	  return block;
	}
	function create_fragment$1$1(ctx) {
	  ...
	  let each_value = ensure_array_like_dev(/*$_viewResources*/ctx[4]);
	  let each_blocks = [];
	  for (let i = 0; i < each_value.length; i += 1) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[2].lines);
	      add_location(div0, file$1, 36, 8, 1000);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[2].content);
	      add_location(div1, file$1, 35, 4, 961);
	      attr_dev(div2, "class", div2_class_value = /*$theme*/ctx[2].body);
	      add_location(div2, file$1, 30, 0, 876);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	    m: function mount(target, anchor) {
	      ...
	      current = true;
	      if (!mounted) {
	        dispose = listen_dev(div2, "scroll", /*handleScroll*/ctx[16], false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(ctx, dirty) {
	      ...
	      if (dirty[0] & /*$_viewResources*/16) {
	        each_value = ensure_array_like_dev(/*$_viewResources*/ctx[4]);
	        let i;
	        for (i = 0; i < each_value.length; i += 1) {
	...
	function instance$1$1($$self, $$props, $$invalidate) {
	  ...
	  $$self.$inject_state = $$props => {
	    if ('_bodyEl' in $$props) $$invalidate(5, _bodyEl = $$props._bodyEl);
	    if ('_headerEl' in $$props) $$invalidate(6, _headerEl = $$props._headerEl);
	    if ('_sidebarEl' in $$props) $$invalidate(7, _sidebarEl = $$props._sidebarEl);
	    if ('_dayTimes' in $$props) $$invalidate(8, _dayTimes = $$props._dayTimes);
	    if ('_dayTimeLimits' in $$props) $$invalidate(9, _dayTimeLimits = $$props._dayTimeLimits);
	    if ('_viewResources' in $$props) $$invalidate(10, _viewResources = $$props._viewResources);
	    if ('_viewDates' in $$props) $$invalidate(11, _viewDates = $$props._viewDates);
	    if ('scrollTime' in $$props) $$invalidate(12, scrollTime = $$props.scrollTime);
	    if ('slotDuration' in $$props) $$invalidate(13, slotDuration = $$props.slotDuration);
	    if ('slotWidth' in $$props) $$invalidate(14, slotWidth = $$props.slotWidth);
	    if ('theme' in $$props) $$invalidate(15, theme = $$props.theme);
	    if ('el' in $$props) $$invalidate(0, el = $$props.el);
	  };
	  if ($$props && "$$inject" in $$props) {
	  ...
	  return [el, $_viewDates, $theme, $_dayTimes, $_viewResources, _bodyEl, _headerEl, _sidebarEl, _dayTimes, _dayTimeLimits, _viewResources, _viewDates, scrollTime, slotDuration, slotWidth, theme, handleScroll, $scrollTime, div2_binding];
	}
	...
	const file$9 = "packages/resource-timeline/src/View.svelte";
	function create_fragment$9(ctx) {
	  ...
	  const block = {
	    c: function create() {
	      ...
	      t1 = space();
	      create_component(body.$$.fragment);
	      attr_dev(div0, "class", div0_class_value = /*$theme*/ctx[0].main);
	      add_location(div0, file$9, 11, 4, 275);
	      attr_dev(div1, "class", div1_class_value = /*$theme*/ctx[0].container);
	      add_location(div1, file$9, 9, 0, 223);
	    },
	    l: function claim(nodes) {
	      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
	    },
	...
	function create_fragment$3(ctx) {
	  ...
	  const block = {
	    ...
	    m: function mount(target, anchor) {
	      if (!mounted) {
	        dispose = [listen_dev(window_1, "pointermove", /*handlePointerMove*/ctx[33], false, false, false), listen_dev(window_1, "pointerup", /*handlePointerUp*/ctx[34], false, false, false), listen_dev(window_1, "pointercancel", /*handlePointerUp*/ctx[34], false, false, false), listen_dev(window_1, "scroll", /*handleScroll*/ctx[0], false, false, false), listen_dev(window_1, "selectstart", createPreventDefaultHandler(/*complexAction*/ctx[35]), false, false, false), listen_dev(window_1, "contextmenu", function () {
	        ...
	        }, false, false, false), listen_dev(window_1, "touchstart", /*handleTouchStart*/ctx[36], false, false, false), listen_dev(window_1, "touchmove", /*touchmove_handler*/ctx[42], {
	          passive: false
	        }, false, false)];
	        mounted = true;
	      }
	...
	function instance$3($$self, $$props, $$invalidate) {
	  ...
	  function handlePointerUp(jsEvent) {
	    ...
	    if (action && jsEvent.isPrimary) {
	      ...
	      interacting = false;
	      action = fromX = fromY = toX = toY = event = display = date = newDate = resource = newResource = delta = allDay = set_store_value(_iClass, $_iClass = minEnd = selectStep = margin = undefined, $_iClass);
	  ...
	  function calcViewport() {
	    ...
	    viewport = [max(0, clipRect.left + (timelineView($view) ? 1 : $_dayGrid ? 0 : 8)), min(document.documentElement.clientWidth, clipRect.left + clipEl.clientWidth) - 2, max(0, bodyRect.top // top
	  ...
	  $$self.$inject_state = $$props => {
	    ...
	    if ('_bodyEl' in $$props) $$invalidate(8, _bodyEl = $$props._bodyEl);
	    if ('dateClick' in $$props) $$invalidate(9, dateClick = $$props.dateClick);
	    if ('dragScroll' in $$props) $$invalidate(10, dragScroll = $$props.dragScroll);
	    if ('datesAboveResources' in $$props) $$invalidate(11, datesAboveResources = $$props.datesAboveResources);
	    if ('eventDragMinDistance' in $$props) $$invalidate(12, eventDragMinDistance = $$props.eventDragMinDistance);
	    if ('eventDragStart' in $$props) $$invalidate(13, eventDragStart = $$props.eventDragStart);
	    if ('eventDragStop' in $$props) $$invalidate(14, eventDragStop = $$props.eventDragStop);
	    if ('eventDrop' in $$props) $$invalidate(15, eventDrop = $$props.eventDrop);
	    if ('eventLongPressDelay' in $$props) $$invalidate(16, eventLongPressDelay = $$props.eventLongPressDelay);
	    if ('eventResizeStart' in $$props) $$invalidate(17, eventResizeStart = $$props.eventResizeStart);
	    if ('eventResizeStop' in $$props) $$invalidate(18, eventResizeStop = $$props.eventResizeStop);
	    if ('eventResize' in $$props) $$invalidate(19, eventResize = $$props.eventResize);
	    if ('longPressDelay' in $$props) $$invalidate(20, longPressDelay = $$props.longPressDelay);
	    if ('selectable' in $$props) $$invalidate(21, selectable = $$props.selectable);
	    if ('selectFn' in $$props) $$invalidate(22, selectFn = $$props.selectFn);
	    if ('selectBackgroundColor' in $$props) $$invalidate(23, selectBackgroundColor = $$props.selectBackgroundColor);
	    if ('selectLongPressDelay' in $$props) $$invalidate(24, selectLongPressDelay = $$props.selectLongPressDelay);
	    if ('selectMinDistance' in $$props) $$invalidate(25, selectMinDistance = $$props.selectMinDistance);
	    if ('slotDuration' in $$props) $$invalidate(26, slotDuration = $$props.slotDuration);
	    if ('slotHeight' in $$props) $$invalidate(27, slotHeight = $$props.slotHeight);
	    if ('slotWidth' in $$props) $$invalidate(28, slotWidth = $$props.slotWidth);
	    if ('unselectFn' in $$props) $$invalidate(29, unselectFn = $$props.unselectFn);
	    if ('unselectAuto' in $$props) $$invalidate(30, unselectAuto = $$props.unselectAuto);
	    if ('unselectCancel' in $$props) $$invalidate(31, unselectCancel = $$props.unselectCancel);
	    if ('view' in $$props) $$invalidate(32, view = $$props.view);
	  ...
	  return [handleScroll, timer, _iEvents, _iClass, _events, _view, _dayGrid, _draggable, _bodyEl, dateClick, dragScroll, datesAboveResources, eventDragMinDistance, eventDragStart, eventDragStop, eventDrop, eventLongPressDelay, eventResizeStart, eventResizeStop, eventResize, longPressDelay, selectable, selectFn, selectBackgroundColor, selectLongPressDelay, selectMinDistance, slotDuration, slotHeight, slotWidth, unselectFn, unselectAuto, unselectCancel, view, handlePointerMove, handlePointerUp, complexAction, handleTouchStart, drag, select, noAction, unselect, noClick, touchmove_handler, contextmenu_handler];
	}
	...
	function create_fragment$2(ctx) {
	  ...
	  const block = {
	    ...
	    m: function mount(target, anchor) {
	      if (!mounted) {
	        dispose = [listen_dev(window, "pointermove", /*handlePointerMove*/ctx[3], false, false, false), listen_dev(window, "scroll", /*handleScroll*/ctx[0], false, false, false)];
	        mounted = true;
	      }
	    },
	    p: noop$1,
	...
	function instance$2($$self, $$props, $$invalidate) {
	  ...
	  function createPointerEvent(idx) {
	    set_store_value(_iEvents, $_iEvents[idx] = {
	      id: '{pointer}',
	      title: '',
	      display: 'pointer',
	      extendedProps: {},
	...
	function create_if_block$1(ctx) {
	  ...
	  const block = {
	    ...
	    m: function mount(target, anchor) {
	      insert_dev(target, div, anchor);
	      if (!mounted) {
	        dispose = listen_dev(div, "pointerdown", /*pointerdown_handler*/ctx[8], false, false, false);
	        mounted = true;
	      }
	    },
	    p: function update(ctx, dirty) {
	...
	class index extends index$7 {
	  constructor(el, options) {
	    super({
	      target: el,
	      props: {
	        plugins: [index$6, index$5, index$4, index$3, index$2, index$1],
	        options
	      }
	    });
	  }
