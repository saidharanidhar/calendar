...
function create_each_block$5(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = action_destroyer(setContent_action = setContent.call(null, time_1, [0, 1].includes(/*time*/ ctx[9][2])
				? /*time*/ ctx[9][1]
				: ''));
		...
		p(new_ctx, dirty) {
			...
			if (setContent_action && is_function(setContent_action.update) && dirty & /*$_times*/ 4) setContent_action.update.call(null, [0, 1].includes(/*time*/ ctx[9][2])
			? /*time*/ ctx[9][1]
			: '');
		},
		d(detaching) {
